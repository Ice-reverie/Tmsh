...
namespace GUI {
     ...
     * @date   2025-06-17
     */
    class PluginGmshExecAPI GUIRegionMeshSizeCylinderDialog : public Core::FITKDialog
    {
        Q_OBJECT
    ...
    public:
         ...
         * @date   2025-06-17
         */
        GUIRegionMeshSizeCylinderDialog(Core::FITKActionOperator* oper,QWidget* parent = nullptr);
        /**
         * @brief    析构
         * @return   void
         * @author   guqingtao (15598887859@163.com)
