/**********************************************************************
 * @file   GUIGeometrySolidSplitterDialog.h
 * @brief  体分割
 * @author guqingtao (15598887859@163.com)
 * @date   2025-04-03
 *********************************************************************/
#ifndef GUIGEOMETRYSOLIDSPLITTERDIALOG_H
#define GUIGEOMETRYSOLIDSPLITTERDIALOG_H
...
namespace Ui { class GUIGeometrySolidSplitterDialog; }
namespace Interface {
...
namespace GUI {
     ...
     * @date   2025-04-03
     */
    class PluginGeoAbstractAPI GUIGeometrySolidSplitterDialog : public Core::FITKDialog
    {
        Q_OBJECT
    ...
    public:
         ...
         * @date   2025-04-03
         */
        GUIGeometrySolidSplitterDialog(Core::FITKActionOperator* oper,QWidget* parent = nullptr);
        /**
         * @brief    析构
         * @return   void
         * @author   guqingtao (15598887859@163.com)
         * @date     2025-04-03
         */
        ~GUIGeometrySolidSplitterDialog();
    private:
        /**
         * @brief    初始化
         * @return   void
    ...
    private:
         ...
         * @date   2025-04-03
         */
        Ui::GUIGeometrySolidSplitterDialog *_ui{};
        /**
         * @brief  几何数据对象
         * @author guqingtao (15598887859@163.com)
         * @date   2025-04-03
...
#endif // GUIGEOMETRYSOLIDSPLITTERDIALOG_H
