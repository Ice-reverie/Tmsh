/**********************************************************************
 * @file   GUIGeometryFaceSplitterDialog.h
 * @brief  面分割
 * @author guqingtao (15598887859@163.com)
 * @date   2025-04-03
 *********************************************************************/
#ifndef GUIGEOMETRYFACESPLITTERDIALOG_H
#define GUIGEOMETRYFACESPLITTERDIALOG_H
...
namespace Ui { class GUIGeometryFaceSplitterDialog; }
namespace Interface {
...
namespace GUI {
     ...
     * @date   2025-04-03
     */
    class PluginGeoAbstractAPI GUIGeometryFaceSplitterDialog : public Core::FITKDialog
    {
        Q_OBJECT
    ...
    public:
         ...
         * @date   2025-04-03
         */
        GUIGeometryFaceSplitterDialog(Core::FITKActionOperator* oper,QWidget* parent = nullptr);
        /**
         * @brief    析构
         * @return   void
         * @author   guqingtao (15598887859@163.com)
    ...
    private:
         ...
         * @date   2025-04-03
         */
        Ui::GUIGeometryFaceSplitterDialog *_ui{};
        /**
         * @brief  几何数据对象
         * @author guqingtao (15598887859@163.com)
         * @date   2025-04-03
...
#endif // GUIGEOMETRYFACESPLITTERDIALOG_H
