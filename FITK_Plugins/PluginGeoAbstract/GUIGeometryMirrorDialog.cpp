...
namespace GUI {
        ...
        :Core::FITKDialog(parent), _oper(oper)
    {
        ...
        {
            connect(pickProvider, &Graph::GraphPickProvider::sig_pickedOver, this, &GUIGeometryMirrorDialog::pickFinishedOper);
        }
        this->init();
    }
    ...
    void GUIGeometryMirrorDialog::init()
    {
        ...
        _ui->comboBox_Tool->addItem(tr("Point"), int(Graph::PickObjType::PickGeoVertex));
    ...
    QString GUIGeometryMirrorDialog::getNameText()
    {
    ...
    void GUIGeometryMirrorDialog::pickFinishedOper()
    {
        ...
        else if (_pickFlag == PickFlag::Tool)
        {
            ...
            if (Graph::PickObjType(_ui->comboBox_Tool->currentData().toInt()) == Graph::PickObjType::PickGeoVertex)
                _virtualTool.Type = Interface::FITKGeoEnum::VTopoShapeType::VSPoint;
            else if (Graph::PickObjType(_ui->comboBox_Tool->currentData().toInt()) == Graph::PickObjType::PickGeoCurve)
    ...
    void GUIGeometryMirrorDialog::createMirrorData()
    {
    ...
    void GUIGeometryMirrorDialog::enablePickSig(Graph::PickObjType objType, Graph::PickMethod methodType)
    {
        Graph::GraphDataPickInfoStru pickInfo = Graph::GraphDataPickInfo::GetPickInfo();
