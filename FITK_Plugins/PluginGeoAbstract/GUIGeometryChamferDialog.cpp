...
namespace GUI {
        ...
        :Core::FITKDialog(parent), _oper(oper)
    {
        ...
        {
            connect(pickProvider, &Graph::GraphPickProvider::sig_pickedData, this, &GUIGeometryChamferDialog::pickFinishedOper);
        }
        this->init();
    }
    ...
    void GUIGeometryChamferDialog::init()
    {
        ...
        _obj = geoFactory->createCommand(Interface::FITKGeoEnum::FITKGeometryComType::FGTChamferSolid);
        if (!_obj) return;
        //获取几何管理器
    ...
    QString GUIGeometryChamferDialog::getNameText()
    {
    ...
    void GUIGeometryChamferDialog::createChamferData()
    {
        Interface::FITKAbsGeoModelChamferSolid* chamferModel = dynamic_cast<Interface::FITKAbsGeoModelChamferSolid*>(_obj);
        ...
        _objID = chamferModel->getDataObjectID();
    }
    ...
    void GUIGeometryChamferDialog::enablePickSig(Graph::PickObjType objType, Graph::PickMethod methodType)
    {
        Graph::GraphDataPickInfoStru pickInfo = Graph::GraphDataPickInfo::GetPickInfo();
