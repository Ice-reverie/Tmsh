...
namespace GUI {
        ...
        :Core::FITKDialog(parent), _oper(oper)
    {
        ...
        {
            connect(pickProvider, &Graph::GraphPickProvider::sig_pickedOver, this, &GUIGeometryCylinderDialog::pickFinishedOper);
        }
        this->init();
    }
    ...
    QString GUIGeometryCylinderDialog::getNameText()
    {
    ...
    void GUIGeometryCylinderDialog::createCylinderData()
    {
    ...
    void GUIGeometryCylinderDialog::enablePickSig(Graph::PickObjType objType, Graph::PickMethod methodType)
    {
        Graph::GraphDataPickInfoStru pickInfo = Graph::GraphDataPickInfo::GetPickInfo();
