...
rem Deploys Qt runtime dependencies into the Release output folder via windeployqt.
rem Default target: output\bin\PythonQt_QtAll-Qt5-Python3.7.dll
rem Usage:
rem   deploy_qt_release.bat [path-to-target-dll-or-exe] [--no-pause|--pause] [--trace]
...
set "OPT_FORCE_PAUSE="
set "OPT_TRACE="
set "DEFAULT_TARGET=output\bin\PythonQt_QtAll-Qt5-Python3.7.dll"
set "TARGET="
