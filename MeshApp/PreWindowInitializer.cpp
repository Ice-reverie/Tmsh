...
void PreWindowInteractionStyle::OnLeftButtonUp()
{
    ...
    // 只有在逐个选择模式下支持框选。
    bool canAreaPick = Graph::GraphDataPickInfo::GetPickInfo()._pickMethod == Graph::PickMethod::PMIndividually;
...
void PreWindowInteractionStyle::OnMouseMove()
{
    ...
    bool needDrawRect = (Graph::GraphDataPickInfo::GetPickInfo()._pickMethod == Graph::PickMethod::PMIndividually ||
        Graph::GraphDataPickInfo::GetPickInfo()._pickMethod == Graph::PickMethod::PMNone);
...
void PreWindowInteractionStyle::pick(bool isPreview)
{
    ...
    // 获取当前拾取类型。
    Graph::PickObjType type = Graph::GraphDataPickInfo::GetPickInfo()._pickObjType;
    switch (type) {
...
void PreWindowInteractionStyle::slot_pickActivated(int pickType)
{
    ...
    case -1: // 关闭拾取
        ...
        break;
    case 3001: // 网格节点
        // 这里可能需要根据实际情况映射到Graph::PickObjType的枚举值
        pickInfo._pickObjType = Graph::PickObjType::PickNone; // 暂时设为PickNone，需要根据实际定义调整
        pickInfo._pickMethod = Graph::PickMethod::PMIndividually;
        break;
    case 3002: // 网格单元
        // 这里可能需要根据实际情况映射到Graph::PickObjType的枚举值
        pickInfo._pickObjType = Graph::PickObjType::PickNone; // 暂时设为PickNone，需要根据实际定义调整
        ...
        break;
    case 3003: // 几何点
        pickInfo._pickObjType = Graph::PickObjType::PickGeoVertex;
        pickInfo._pickMethod = Graph::PickMethod::PMIndividually;
        break;
    case 3004: // 几何线
        pickInfo._pickObjType = Graph::PickObjType::PickGeoCurve;
        pickInfo._pickMethod = Graph::PickMethod::PMIndividually;
        break;
    case 3005: // 几何面
        pickInfo._pickObjType = Graph::PickObjType::PickGeoFace;
        pickInfo._pickMethod = Graph::PickMethod::PMIndividually;
        break;
    case 3006: // 几何体
        pickInfo._pickObjType = Graph::PickObjType::PickGeoSolid;
        pickInfo._pickMethod = Graph::PickMethod::PMIndividually;
        break;
    default:
        // 默认关闭拾取
