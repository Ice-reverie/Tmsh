 ...
 * 
 */
#ifndef _MESH_APP_WORKBENCH_HANDLER_H___
#define _MESH_APP_WORKBENCH_HANDLER_H___
 ...
 * @date 2024-08-26
 */
class MeshAppWorkBenchHandler : public AppFrame::FITKWorkBenchHandler
{
public:
     /**
      ...
      * @date 2024-08-26
      */
    explicit MeshAppWorkBenchHandler() = default;
    /**
     * @brief Destroy the Flow App Work Bench Handler object
     * @author libaojun (libaojunqd@foxmail.com)
     * @date 2024-08-26
     */
    virtual ~MeshAppWorkBenchHandler() = default;
     /**
      * @brief 处理命令行
      * @author libaojun (libaojunqd@foxmail.com)
      * @date 2024-08-26
