...
namespace GUIOper
{
    ...
    private:
         ...
         * @date    2024-07-19
         */
        void addGraphObjectToWidget(Graph::GraphObjectBase* obj, Comp::FITKGraph3DWindowVTK* graphWidget);
    ...
    private:
         ...
         * @date   2024-12-26
         */
        Graph::GraphObjectPickPreview* m_graphObjPreview{ nullptr };
        /**
         * @brief   拾取信息管理器。
         * @author  ChengHaotian (yeguangbaozi@foxmail.com)
         * @date    2024-07-19
         */
        Graph::GraphPickProvider* m_pickedProvider{ nullptr };
