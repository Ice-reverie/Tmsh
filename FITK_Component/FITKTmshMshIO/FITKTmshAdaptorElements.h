/**********************************************************************
 * @file   FITKTmshAdaptorElements.h
 * @brief  Tmsh msh 单元读写适配器
 * @author liuzhonghua (liuzhonghuaszch@163.com)
 * @date   2024-11-29
 *********************************************************************/
#ifndef __FITKTMSHADAPTORELEMENTS_R_H__
#define __FITKTMSHADAPTORELEMENTS_R_H__
...
namespace Tmsh
{
     ...
     * @date   2024-11-29
     */
    class FITKTmshAdaptorElements : public FITKTmshAbstractAdaptor
    {
    public:
        explicit FITKTmshAdaptorElements() = default;
        virtual ~FITKTmshAdaptorElements() = default;
    ...
    Register2FITKIOAdaptorFactory(Tmsh, FITKTmshAdaptorElements, FITKTmshAdaptorElements)
}
