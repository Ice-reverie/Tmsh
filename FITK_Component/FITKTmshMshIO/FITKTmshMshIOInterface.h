/**********************************************************************
 * @file   FITKTmshMshIOInterface.h
 * @brief  Tmsh msh网格读写接口
 * @author liuzhonghua (liuzhonghuaszch@163.com)
 * @date   2024-11-28
 *********************************************************************/
#ifndef _FITK_TMSH_MEH_IO_INTERFACE_H___
#define _FITK_TMSH_MEH_IO_INTERFACE_H___
...
namespace Tmsh
{
    class FITKTmshMshIOAPI FITKTmshMshIOInterface : public QObject,
    ...
    public:
         ...
         * @date   2024-11-28
         */
        explicit FITKTmshMshIOInterface() = default;
        /**
         * @brief    析构函数
         * @author   liuzhonghua (liuzhonghuaszch@163.com)
         * @date     2024-11-28
         */
        virtual ~FITKTmshMshIOInterface() = default;
        /**
         * @brief  获取组件名称
         * @return 组件名称
         * @author liuzhonghua (liuzhonghuaszch@163.com)
