/**********************************************************************
 * @file   FITKTmshMshIOReader.h
 * @brief  Tmsh msh网格文件读取
 * @author liuzhonghua (liuzhonghuaszch@163.com)
 * @date   2024-11-29
 *********************************************************************/
#ifndef _FITK_TMSH_MSH_IO_READER_H___
#define _FITK_TMSH_MSH_IO_READER_H___

#include "FITKTmshMshIOAPI.h"
...
namespace Tmsh
{
     ...
     * @date   2024-11-29
     */
    class FITKTmshMshIOAPI FITKTmshMshIOReader : public Interface::FITKAbstractTextReader
    {
        Q_OBJECT
    public:
        explicit FITKTmshMshIOReader() = default;
        virtual ~FITKTmshMshIOReader() = default;
        /**
         * @brief    设置集合管理器
        ...
        /**
         * @brief    获取读取工具
         * @return   FITKTmshMshIOReaderTool *
         * @author   liuzhonghua (liuzhonghuaszch@163.com)
         * @date     2025-09-03
         */
        FITKTmshMshIOReaderTool* getReaderTool();
        /**
         * @brief 打印控制台消息
