            ...
            if (part)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        const TopoDS_Shape & solidsShape = FITKOCCComandCommon::removeSplitter(add);
    ...
    bool FITKOCCModelMultiSectionSolid::update()
    {
        ...
        try {
            ...
            if (part)
            {
                ...
                for (const TopoDS_Shape & partSubShape : partSubShapes3D)
                {
                    BRepAlgoAPI_Section intSec(shape, partSubShape);
                    intSec.Build();
                    if (!intSec.IsDone())
                    {
                        return false;
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        BRepAlgoAPI_Fuse add = BRepAlgoAPI_Fuse(compoundInter, shape);
                        if (!add.IsDone())
                        {
                            return false;
                        }
